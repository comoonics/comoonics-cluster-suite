#!/usr/bin/python
"""
lockfile can be used to create one or more semaphore files. If lockfile cannot create all the specified files (in the specified order), it waits sleeptime
(defaults to 8) seconds and retries the last file that didnot succeed. You can specify the number of retries to do until failure is returned.
If the number of retries is -1 (default, i.e., -r-1) lockfile will retry forever.
...
#########################
# $Log: lockfile.py,v $
# Revision 1.2  2008-04-09 12:21:32  marc
# initial revision
#
